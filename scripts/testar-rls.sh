...
cp "$RAIZ"/supabase/tests/harness.sql \
   ...
   "$RAIZ"/supabase/migrations/0003_anunciado_em.sql \
   "$RAIZ"/supabase/migrations/0004_datajud_nucleo.sql \
...
for arquivo in harness.sql 0001_init.sql 0002_auth_saas.sql 0003_anunciado_em.sql 0004_datajud_nucleo.sql rls_test.sql; do
